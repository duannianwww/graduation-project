...
<table class="sea">
    ...
    <%
        ...
        List<shiti> list =book.seaquestion();;
...
<a href="question_search_xuanzhe.jsp" style="text-decoration-line: none"><button type="button" class="update" >仅显示选择与多选</button></a>
<a href="question_search_panduan.jsp"><button type="button" class="update" >仅显示判断题</button></a>
<a href="question_search_tiankong.jsp"><button type="button" class="update" >仅显示填空题</button></a>
<a href="question_search_wenda.jsp"><button type="button" class="update" >仅显示问答题</button></a>
</body>
</html>
